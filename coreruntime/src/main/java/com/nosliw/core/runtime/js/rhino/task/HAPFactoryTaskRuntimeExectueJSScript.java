...
@Component
public class HAPFactoryTaskRuntimeExectueJSScript implements HAPFactoryTaskRuntime{

	@Override
	public String getRuntimeType() {    return HAPInfoRuntimeTask.RUNTIMETASK_TYPE_EXECUTESCRIPTEXPRESSION;   }
