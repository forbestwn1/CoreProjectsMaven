...
public class HAPUtilityTaskInterface {
	...
	public static String readTaskInterfaceContent(HAPDataSourceConfigure taskInterfaceConfigure, String id) {
		return HAPUtilityFileNio.readFile(HAPUtilityFileNio.buildPath(taskInterfaceConfigure.getPath(), id + ".json"));
	}

	public static HAPBlockServiceInterface buildTaskInterfaceBlock(HAPDataSourceConfigure taskInterfaceConfigure, String id) {
