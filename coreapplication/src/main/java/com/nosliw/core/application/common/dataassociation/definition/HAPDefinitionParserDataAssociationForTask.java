...
public class HAPDefinitionParserDataAssociationForTask {
	...
	public static HAPDefinitionDataAssociationForTask parse(JSONObject jsonObj, HAPServiceParseEntity entityParseService) {
		...
		if(outputMappingJson!=null) {
			for(Object key : outputMappingJson.keySet()) {
				HAPDefinitionDataAssociation dataAssociation = HAPDefinitionParserDataAssociation.buildDefinitionByJson(outputMappingJson.optJSONObject((String)key), entityParseService);
