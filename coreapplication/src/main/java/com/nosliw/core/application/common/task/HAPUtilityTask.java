...
public class HAPUtilityTask {
	...
	public static HAPBrick getDescdentBrickLocalTask(HAPBundleForBrick bundle, HAPPath idPath, String rootNameIfNotProvide) {
	...
	private static HAPPath figureoutTaskPath(HAPBundleForBrick bundle, HAPPath idPath, String rootNameIfNotProvide) {
		HAPPath out = idPath;
	...
	public static HAPPath normalizeBrickPathFroTask(HAPPath path, boolean processEnd, HAPBundleForBrick currentBundle) {
