...
public class HAPManualDefinitionBrickValueContext extends HAPManualDefinitionBrick implements HAPValueContextDefinition{
	...
	@Override
	protected void init() {
		this.setAttributeValueWithBrick(ITEM, this.getManualBrickManager().newBrickDefinition(HAPEnumBrickType.CONTAINERLIST_100));
	}
	...
	private HAPManualDefinitionBrickContainerList getValueStructureContainer() {
		return (HAPManualDefinitionBrickContainerList)this.getAttributeValueOfBrick(ITEM);
	}
