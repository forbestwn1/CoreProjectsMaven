...
public class HAPManualEnumBrickType {
	...
	public static HAPIdBrickType ATTACHMENT_100 = new HAPIdBrickType(HAPConstantShared.RUNTIME_RESOURCE_TYPE_ATTACHMENT, "1.0.0");
