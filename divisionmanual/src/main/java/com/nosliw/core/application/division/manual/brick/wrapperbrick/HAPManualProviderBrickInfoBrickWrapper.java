...
@Component
public class HAPManualProviderBrickInfoBrickWrapper extends HAPManualProviderBrickInfoImp{

	public HAPManualProviderBrickInfoBrickWrapper(HAPManualManagerBrick manualBrickMan,
			HAPManagerApplicationBrick brickMan) {
		super(manualBrickMan, brickMan);
	}

	@Override
	public HAPIdBrickType getBrickTypeId() {   return HAPEnumBrickType.WRAPPERBRICK_100;   }

	@Override
	protected HAPManualDefinitionPluginParserBrick newBrickParser() {
		return new HAPManualPluginParserBrickWrapperBrick(this.getManualBrickManager(), this.getBrickManager());
	}

	@Override
	protected HAPManualPluginProcessorBrick newBrickProcessor() {
		return new HAPManualPluginProcessorBlockSimpleImpWrapperBrick();
	}
