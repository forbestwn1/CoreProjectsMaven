...
public class HAPManualProviderBrickInfoDataExpressionElementInLibrary extends HAPManualProviderBrickInfoImp{
	...
	protected HAPManualDefinitionPluginParserBrick newBrickParser() {
		return new HAPManualPluginParserBlockDataExpressionElementInLibrary(this.getManualBrickManager(), this.getBrickManager(), this.m_dataExpressionParser, this.m_entityParseService);
	}
