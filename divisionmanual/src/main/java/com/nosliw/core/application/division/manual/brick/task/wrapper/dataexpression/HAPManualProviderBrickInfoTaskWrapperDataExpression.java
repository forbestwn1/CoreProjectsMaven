...
public class HAPManualProviderBrickInfoTaskWrapperDataExpression extends HAPManualProviderBrickInfoImp{
	...
	public HAPManualProviderBrickInfoTaskWrapperDataExpression(
	...
	@Override
	protected HAPManualPluginProcessorBrick newBrickProcessor() {   return new HAPManualPluginProcessorBlockTaskWrapperDataExpression(this.m_withVariableMan);  }
