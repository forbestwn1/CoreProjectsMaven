...
public class HAPManualProviderBrickInfoDataExpressionStandAlone extends HAPManualProviderBrickInfoImp{
	...
	protected HAPManualDefinitionPluginParserBrick newBrickParser() {
		return new HAPManualPluginParserBlockDataExpressionStandAlone(this.getManualBrickManager(), this.getBrickManager(), this.m_dataExpressionParser, this.m_entityParseService);
	}
