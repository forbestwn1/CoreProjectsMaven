...
public class HAPManualProviderBrickInfoMultipleUIContent implements HAPManualProviderBrickInfoMultiple{
	...
	public HAPManualProviderBrickInfoMultipleUIContent(
		...
		m_providers.add(new HAPManualProviderBrickInfoImp(m_manualBrickMan, m_brickMan) {
			...
			@Override
			protected HAPManualDefinitionPluginParserBrick newBrickParser() {  return new HAPManualPluginParserBlockComplexUIContent(m_manualBrickMan, m_brickMan, m_entityParseService);  }
			@Override
		...
		m_providers.add(new HAPManualProviderBrickInfoImp(manualBrickMan, brickMan) {
			...
			@Override
			protected HAPManualDefinitionPluginParserBrick newBrickParser() {	return new HAPManualPluginParserBlockComplexUICustomerTag(m_manualBrickMan, m_brickMan, m_uiTagMan, m_entityParseService);	}
			@Override
