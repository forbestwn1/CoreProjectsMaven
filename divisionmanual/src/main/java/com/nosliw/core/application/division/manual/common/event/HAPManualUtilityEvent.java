...
public class HAPManualUtilityEvent {
	...
	public static void buildValuePortForEventHandlerTask(HAPEventDefinition eventDef, HAPEventHandlerReferenceTask handlerTask, String rootNameIfNotProvide, HAPBundleForBrick bundle) {
