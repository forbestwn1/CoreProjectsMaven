...
public class HAPManualUtilityEvent {
	...
	public static void buildValuePortForEventHandlerTask(HAPEventDefinition eventDef, HAPEventReferenceHandlerTask handlerTask, String rootNameIfNotProvide, HAPBundleForBrick bundle) {
