...
var dataTypeDefinition = nosliw.getDataTypeDefinition("test.url", "1.1.0");

//define what this data type globlely requires (operation, datatype, library)
dataTypeDefinition.requires = {
//	"operation" : { 
//		op: "test.text;1.0.0;text_normal3"
//	},
////	"datatype1" : {
////		text : "test.text;1.0.0"
////	},
//	"library" : {
...
dataTypeDefinition.operations['url_normal2'] = {
	...
	requires:{
		"operation" : { 
			op1: "test.text;1.0.0;text_normal1",
			op2: "test.text;1.0.0;text_normal2",
		},
//		"datatype1" : {
//			text : "test.text;1.0.0"
//		},
