...
public class HAPStoryElementAccessoryCommand extends HAPStoryElementAccessory{
	...
	public static HAPPath getAddRequestParmChildPath(String parmName) {		return HAPStoryUtilityElement.getAddElementChildPath(new HAPPath(CHILD_REQUEST), parmName);  }
	public static HAPPath getRequestParmEndPointPath(String parmName) {		return new HAPPath(new String[] {CHILD_REQUEST, parmName});	}

	public static HAPPath getAddResponseParmChildPath(String resultName, String parName) {		return HAPStoryUtilityElement.getAddElementChildPath(new HAPPath(new String[] {CHILD_RESPONSE, resultName}), parName);	}
