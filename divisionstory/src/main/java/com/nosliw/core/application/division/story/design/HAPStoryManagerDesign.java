...
public class HAPStoryManagerDesign {
	...
	public HAPStoryDesign newStoryDesign(String builderId, String designId) {
		...
		HAPStoryDesign out = new HAPStoryDesign(designId!=null?designId:this.generateId(), builderId);
	...
	private void saveStoryDesign(HAPStoryDesign storyDesign) {  this.m_designs.put(storyDesign.getId(), storyDesign);	}
