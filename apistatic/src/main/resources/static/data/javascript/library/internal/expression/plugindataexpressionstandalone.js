...
var node_createDataExpressionStandalonePlugin = function(){
	...
	var loc_out = {
		...
		getCreateEntityCoreRequest : function(complexEntityDef, internalValuePortContainerId, externalValuePortContainerId, bundleCore, configure, handlers, request){
			return node_createServiceRequestInfoSimple(undefined, function(request){
				return loc_createDataExpressionStandaloneCore(complexEntityDef, internalValuePortContainerId, bundleCore, configure);
			}, handlers, request);
		}
...
var loc_createDataExpressionStandaloneCore = function(complexEntityDef, valueContextId, bundleCore, configure){
	...
	var loc_out = {
		...
		getTaskExecuteRequest : function(runtimeEnv, handlers, request){
			...
			var dataExpression = loc_complexEntityDef.getAttributeValue(node_COMMONATRIBUTECONSTANT.BLOCKDATAEXPRESSIONSTANDALONE_VALUE)[node_COMMONATRIBUTECONSTANT.DATAEXPRESSIONSTANDALONE_EXPRESSION];
...
packageObj.createChildNode("createDataExpressionStandalonePlugin", node_createDataExpressionStandalonePlugin); 
