...
var node_createTaskWrapperDataExpressionPlugin = function(){
	...
	var loc_out = {
		...
		getCreateEntityCoreRequest : function(complexEntityDef, internalValuePortContainerId, externalValuePortContainerId, bundleCore, configure, handlers, request){
			return node_createServiceRequestInfoSimple(undefined, function(request){
				return loc_createTaskWrapperDataExpressionCore(complexEntityDef, internalValuePortContainerId, bundleCore, configure);
			}, handlers, request);
		}
...
var loc_createTaskWrapperDataExpressionCore = function(complexEntityDef, valueContextId, bundleCore, configure){
	...
	var loc_out = {
		...
		getTaskExecuteRequest : function(runtimeEnv, handlers, request){
			...
			var dataExpression = loc_complexEntityDef.getAttributeValue(node_COMMONATRIBUTECONSTANT.BLOCKTASKWRAPPERDATAEXPRESSION_DATAEXPRESSION)[node_COMMONATRIBUTECONSTANT.DATAEXPRESSIONSTANDALONE_EXPRESSION];
...
packageObj.createChildNode("createTaskWrapperDataExpressionPlugin", node_createTaskWrapperDataExpressionPlugin); 
