...
public class HAPConstantShared {
		...
		public static final String UITAG_ATTRIBUTE_DATA = "data";
		...
		public static final String GATEWAY_DATATYPE = "dataType";
		...
		public static final String GATEWAY_MANUAL_COMPILE = "manualCompile";
		public static final String GATEWAY_MANUAL_STANDALONE = "manualStandalone";
		public static final String GATEWAY_RHINOTASKRESPONSE = "taskResponseGateway";



		public static final String STANDALONE_PROVIDER_STORY = "story";
		...
		public static final String STORYNODE_TYPE_UIWRAPPER = "UIWrapper";
		...
		public static final String STORYDESIGN_QUESTION_TAG_EXTRAINFOGROUP = "extraInfoGroupTag";
